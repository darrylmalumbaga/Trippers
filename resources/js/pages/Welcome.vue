            ...
            <nav class="flex items-center justify-end gap-4">
                ...
                <template v-else>
                    <button
                        @click="handleLogin"
                        :disabled="loading"
                        class="inline-flex items-center rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#19140035] disabled:opacity-50 dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]"
                    >
                        <svg
                            v-if="loading"
